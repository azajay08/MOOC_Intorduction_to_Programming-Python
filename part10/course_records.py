...
class StudiesApplication:
	...
	def stats(self):
		t_course = self.__studies.total_courses()
		t_creds = self.__studies.total_credits()
		print(f'{t_course} completed courses, a total of {t_creds} credits')
		print(f'mean {self.__studies.mean_grade()}')
		print('grade distribution')
		grade_d = self.__studies.grade_distribution()
